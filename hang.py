...
someWords = '''helium neon hydrogen oxygen fluorine argon nitrogen chlorine
krypton xenon radon arsine cyanogen'''
...
if __name__ == '__main__':
    print('Guess the word! CLUE: word is a name of a gases')
